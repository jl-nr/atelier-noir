...
A neat and small Python tool and library for applying dark-themed transformations to images: contrast boosting, shadow enhancement, monochrome filters, and a simple batch pipeline. It is perfect for stylized preprocessing.
...
- **CLI and Library**: Use as a command-line tool or import as a Python library to use in your apps
...
Or install dependencies from [requirements.txt](requirements.txt) file:
